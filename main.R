...
# Teneis informacion del juego en la wikipedia: https://es.wikipedia.org/wiki/Quarto_(juego)
# Recordad que en esta version no se le pasa la ficha al contrario
# sino que se pone directamente
# Solo se consideran ganadoras las filas, columnas y ambas diagonales


# --------------------------------------------------------------------------

# ESTA ES LA FUNCION QUE DEBES MODIFICAR, AHORA SOLO SE ELIGE LA JUGADA DE
# MANERA ALEATORIA
